...
ROOT = Path(r"c:\Users\hsollim\Desktop\cursor\Genelist_analysis_WMB")
LONG = ROOT / "v3/outputs/subclass_markers_expanded/Subclass_Discriminating_Markers_long.csv"
TIER = ROOT / "v3/outputs/subclass_markers_expanded/GPCR_Specificity_Tiers.csv"
RANK = ROOT / "v3/outputs/gpcr_full/Allen_GPCR_Ranking_subclass.csv"
