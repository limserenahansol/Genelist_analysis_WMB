...
XLSX = V3 / "outputs" / "FINAL_Xenium_panel_ORBm_BMAp_for_MSGS111.xlsx"
BASE = V3 / "outputs" / "xenium_mouse_brain_base_panel.txt"
OUT = V3 / "outputs" / "Jesse_ORB_vs_Xenium_panel.xlsx"
DL = Path.home() / "Downloads" / "Jesse_ORB_vs_Xenium_panel.xlsx"
